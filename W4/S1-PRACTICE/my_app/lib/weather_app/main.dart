...
import 'package:flutter_mini/weather_app/enums.dart';
import 'package:flutter_mini/weather_app/weather_service.dart';
import 'package:flutter_mini/weather_app/weather_data.dart';
import 'dart:async';
...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  String get temperatureString {
    ...
    if (currentDay != SelectedDay.today) {
      temp = currentDayValues.temperatureMin.round();
    } else {
